// Output created by jacc on Wed Oct 11 11:45:11 BRT 2017
...
class TINYParser implements TINYTokens {
    ...
    protected void yyexpand() {
        ...
        Tree[] newyysv = new Tree[2*yyst.length];
    ...
    private int yyr1() { // s : cmds
        { out = new Tree("S", yysv[yysp-1]); yyrv = out; }
        yysv[yysp-=1] = yyrv;
        return 1;
    }

    private int yyr2() { // cmds : cmds ';' cmd
        { yyrv = new Tree("CMDS", yysv[yysp-3], yysv[yysp-2], yysv[yysp-1]); }
        yysv[yysp-=3] = yyrv;
        return yypcmds();
    }

    private int yyr3() { // cmds : cmd
        { yyrv = new Tree("CMDS", yysv[yysp-1]); }
        yysv[yysp-=1] = yyrv;
        return yypcmds();
    }
    ...
    private int yyr10() { // exp : exp '<' exp
        { yyrv = new Tree("EXP", yysv[yysp-3], yysv[yysp-2], yysv[yysp-1]); }
        yysv[yysp-=3] = yyrv;
        return yypexp();
    }
    ...
    private int yyr4() { // cmd : IF exp THEN cmds END
        { yyrv = new Tree("CMD", yysv[yysp-5], yysv[yysp-4], yysv[yysp-3], yysv[yysp-2], yysv[yysp-1]); }
        yysv[yysp-=5] = yyrv;
        return yypcmd();
    }

    private int yyr5() { // cmd : IF exp THEN cmds ELSE cmds END
        { yyrv = new Tree("CMD", yysv[yysp-7], yysv[yysp-6], yysv[yysp-5], yysv[yysp-4], yysv[yysp-3], yysv[yysp-2], yysv[yysp-1]); }
        yysv[yysp-=7] = yyrv;
        return yypcmd();
    }

    private int yyr6() { // cmd : REPEAT cmds UNTIL exp
        { yyrv = new Tree("CMD", yysv[yysp-4], yysv[yysp-3], yysv[yysp-2], yysv[yysp-1]); }
        yysv[yysp-=4] = yyrv;
        return yypcmd();
    }

    private int yyr7() { // cmd : WRITE exp
        { yyrv = new Tree("CMD", yysv[yysp-2], yysv[yysp-1]); }
        yysv[yysp-=2] = yyrv;
        return yypcmd();
    }
    ...
    private int yyr9() { // cmd : ID ATRIB exp
        { yyrv = new Tree("CMD", yysv[yysp-3], yysv[yysp-2], yysv[yysp-1]); }
        yysv[yysp-=3] = yyrv;
        return yypcmd();
    }
